...
// ABConnectivity
#define COCOAPODS_POD_AVAILABLE_ABConnectivity
#define COCOAPODS_VERSION_MAJOR_ABConnectivity 0
#define COCOAPODS_VERSION_MINOR_ABConnectivity 1
#define COCOAPODS_VERSION_PATCH_ABConnectivity 0
